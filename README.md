...
MetroShell is a Delhi-only metro map and route-planning demo for a local
terminal or SSH session. It combines a braille-rendered Delhi NCR map, static
GTFS route data, a keyboard-first FROM/TO picker, and deterministic
schedule-shaped train motion.
